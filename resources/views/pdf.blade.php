...
<br>
    ...
    <table width="50%" border="0" style="margin-left:3%;margin-right:2%;float:left">
        ...
        <tr>
            <td colspan="3">Akses<a style="font: blue; text-decoration: none;" href="{{ route('dashboard') }}"> ppdb.smkwikrama.sch.id/dashboard</a>, login gunakan</td>
        </tr>
        <tr>
            <td colspan="3">Username : {{ $student->nama }}</td>
        </tr>
        <tr>
